  ...
  public class Material : Base
{
    ...
    [SchemaInfo("RevitMaterial", "Creates a Speckle material", "BIM", "Architecture")] // TODO: FIX NAME!
...
{
  /// <summary>
  /// Material in Revit defining all revit properties from Autodesk.Revit.DB.Material
  /// </summary>
  public class RevitMaterial : Material
  {
    ...
    public RevitMaterial(string name, string category, string materialclass, int shiny, int smooth, int transparent,
      List<BuiltElements.Revit.Parameter> parameters = null)
    {
    ...
    [SchemaInfo("RevitMaterial", "Creates a Speckle material", "Revit", "Architecture")]
    public RevitMaterial(string name, string category, string materialclass, int shiny, int smooth, int transparent,
      List<RevitParameter> parameters = null)
    {
      this.parameters = parameters.ToBase();
      this.name = name;
      this.materialCategory = category;
